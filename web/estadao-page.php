...
<head>
	...
	<title>Estadão | Veja as principais notícias</title>
	<link rel="shortcut icon" href="img/estadao.ico" />
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse" id="navbar-main">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="estadao">Estadão</a></li>
			...
			<div class="row">				
				<div id="myTabContent" class="col-lg-9 tab-content">
					<div id="principal" class="tab-pane fade active in">
						<?php 
						include 'com.noticias/estadaonoticias.php';
						$estadaonoticias = new estadaonoticias();
						echo $estadaonoticias->obter_principal();
						?>
					</div>
				    <div id="politica" class="tab-pane fade">
						<?php echo $estadaonoticias->obter_politica();?>					
				    </div>	
					<div id="economia" class="tab-pane fade">
						<?php echo $estadaonoticias->obter_economia();?>					
				    </div>	
					<div id="esporte" class="tab-pane fade">
						<?php echo $estadaonoticias->obter_esporte();?>					
				    </div>	
					<div id="mundo" class="tab-pane fade">
						<?php echo $estadaonoticias->obter_mundo();?>					
				    </div>	
				</div>
				<div class="col-lg-3 pull-right">
					<img class="logo" src="img/estadao.jpg" alt="Estadão"><br />
