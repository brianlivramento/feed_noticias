...
<head>
	...
	<title>R7 | Veja as principais notícias</title>
	<link rel="shortcut icon" href="img/r7.ico" />
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse" id="navbar-main">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="r7">R7</a></li>						
			...
			<div class="row">				
				<div id="myTabContent" class="col-lg-9 tab-content">					
					<div id="principal" class="tab-pane fade active in">
						<?php 
						include 'com.noticias/r7noticias.php';
						$r7noticias = new r7noticias();
						echo $r7noticias->obter_principal();
						?>
					</div>
				    <div id="politica" class="tab-pane fade">
						<?php echo $r7noticias->obter_politica();?>					
				    </div>	
					<div id="economia" class="tab-pane fade">
						<?php echo $r7noticias->obter_economia();?>					
				    </div>	
					<div id="esporte" class="tab-pane fade">
						<?php echo $r7noticias->obter_esporte();?>					
				    </div>	
					<div id="mundo" class="tab-pane fade">
						<?php echo $r7noticias->obter_mundo();?>					
				    </div>	
				</div>
				<div class="col-lg-3 pull-right">
					<img class="logo" src="img/r7.jpg" alt="R7"><br />
