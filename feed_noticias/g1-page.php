...
<head>
	...
	<title>G1 | Veja as principais notícias</title>
	<link rel="shortcut icon" href="img/g1.jpg" />
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse" id="navbar-main">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="g1">G1</a></li>
			...
			<div class="row">				
				<div id="myTabContent" class="col-lg-9 tab-content">
					<div id="principal" class="tab-pane fade active in">
						<?php 
						include 'com.noticias/g1noticias.php';
						$g1noticias = new g1noticias();
						echo $g1noticias->obter_principal();
						?>
					</div>
				    <div id="politica" class="tab-pane fade">
						<?php echo $g1noticias->obter_politica();?>					
				    </div>	
					<div id="economia" class="tab-pane fade">
						<?php echo $g1noticias->obter_economia();?>					
				    </div>	
					<div id="esporte" class="tab-pane fade">
						<?php echo $g1noticias->obter_esporte();?>					
				    </div>	
					<div id="mundo" class="tab-pane fade">
						<?php echo $g1noticias->obter_mundo();?>					
				    </div>	
				</div>
