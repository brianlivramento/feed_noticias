...
<head>
	...
	<title>BBC Brasil | Veja as principais notícias</title>
			...
			<div class="row">				
				<div id="myTabContent" class="col-lg-9 tab-content">
					<div id="principal" class="tab-pane fade active in">
						<?php 
						include 'com.noticias/bbcnoticias.php';
						$bbcnoticias = new bbcnoticias();
						echo $bbcnoticias->obter_principal();
						?>
					</div>
				    <div id="politica" class="tab-pane fade">
						<?php echo $bbcnoticias->obter_politica();?>					
				    </div>	
					<div id="economia" class="tab-pane fade">
						<?php echo $bbcnoticias->obter_economia();?>					
				    </div>	
					<div id="esporte" class="tab-pane fade">
						<?php echo $bbcnoticias->obter_esporte();?>					
				    </div>	
					<div id="mundo" class="tab-pane fade">
						<?php echo $bbcnoticias->obter_mundo();?>					
				    </div>	
				</div>
				<div class="col-lg-3 pull-right">
					<img class="logo" src="img/bbc.jpg" alt="BBC"><br />
