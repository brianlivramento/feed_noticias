...
<head>
	...
	<title>Folha | Veja as principais notícias</title>
	<link rel="shortcut icon" href="img/folha.ico" />
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse" id="navbar-main">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="folha">Folha de S.Paulo</a></li>
			...
			<div class="row">				
				<div id="myTabContent" class="col-lg-9 tab-content">
					<div id="principal" class="tab-pane fade active in">
						<?php 
						include 'com.noticias/folhanoticias.php';
						$folhanoticias = new folhanoticias();
						echo $folhanoticias->obter_principal();
						?>
					</div>
				    <div id="politica" class="tab-pane fade">
						<?php echo $folhanoticias->obter_politica();?>					
				    </div>	
					<div id="economia" class="tab-pane fade">
						<?php echo $folhanoticias->obter_economia();?>					
				    </div>	
					<div id="esporte" class="tab-pane fade">
						<?php echo $folhanoticias->obter_esporte();?>					
				    </div>	
					<div id="mundo" class="tab-pane fade">
						<?php echo $folhanoticias->obter_mundo();?>					
				    </div>	
				</div>
				<div class="col-lg-3 pull-right">
					<img class="logo" src="img/folha.jpg" alt="Folha de S.Paulo"><br />
