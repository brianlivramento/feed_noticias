...
<head>
	...
	<title>UOL | Veja as principais notícias</title>
	<link rel="shortcut icon" href="img/uol.ico" />
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse" id="navbar-main">
					<ul class="nav navbar-nav">
						<li class="active"><a href="uol">UOL</a></li>
			...
			<div class="row">				
				<div id="myTabContent" class="col-lg-9 tab-content">
					<div id="principal" class="tab-pane fade active in">
						<?php 
						include 'com.noticias/uolnoticias.php';
						$uolnoticias = new uolnoticias();
						echo $uolnoticias->obter_principal();
						?>
					</div>
				    <div id="politica" class="tab-pane fade">
						<?php echo $uolnoticias->obter_politica();?>					
				    </div>	
					<div id="economia" class="tab-pane fade">
						<?php echo $uolnoticias->obter_economia();?>					
				    </div>	
					<div id="esporte" class="tab-pane fade">
						<?php echo $uolnoticias->obter_esporte();?>					
				    </div>	
					<div id="mundo" class="tab-pane fade">
						<?php echo $uolnoticias->obter_mundo();?>					
				    </div>	
				</div>
				<div class="col-lg-3 pull-right">
					<img class="logo" src="img/uol.jpg" alt="UOL"><br />
